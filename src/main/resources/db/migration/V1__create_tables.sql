...
CREATE TABLE TBL_LOGRADOURO (
                                id_logradouro UUID PRIMARY KEY,
                                nome VARCHAR(255),
...
CREATE TABLE TBL_VETERINARIO (
                                 id_veterinario UUID PRIMARY KEY,
